...
var useWhenPlaybackStateChanges = function (callback) {
    ...
    react_1.useEffect(function () {
        var didCancel = false;
        var fetchPlaybackState = function () { return __awaiter(void 0, void 0, void 0, function () {
            var playbackState;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, index_1.default.getState()];
...
exports.useTrackPlayerProgress = function (interval) {
    ...
    var needsPoll = usePlaybackStateIs(index_1.State.Playing, index_1.State.Buffering);
    var getProgress = function () { return __awaiter(void 0, void 0, void 0, function () {
